...
const XSocketCallType XSocketCallType_MAX = XREADNAMESERVERDAG;
...
// required string dag = 1;
inline bool X_Changead_Msg::has_dag() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void X_Changead_Msg::set_has_dag() {
  _has_bits_[0] |= 0x00000001u;
}
inline void X_Changead_Msg::clear_has_dag() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void X_Changead_Msg::clear_dag() {
  if (dag_ != &::google::protobuf::internal::kEmptyString) {
    dag_->clear();
  }
  clear_has_dag();
}
inline const ::std::string& X_Changead_Msg::dag() const {
  return *dag_;
}
inline void X_Changead_Msg::set_dag(const ::std::string& value) {
  set_has_dag();
  if (dag_ == &::google::protobuf::internal::kEmptyString) {
    dag_ = new ::std::string;
  }
...
inline void X_Changead_Msg::set_dag(const char* value) {
  set_has_dag();
  if (dag_ == &::google::protobuf::internal::kEmptyString) {
    dag_ = new ::std::string;
  }
...
inline void X_Changead_Msg::set_dag(const char* value, size_t size) {
  set_has_dag();
  if (dag_ == &::google::protobuf::internal::kEmptyString) {
    dag_ = new ::std::string;
  }
...
inline ::std::string* X_Changead_Msg::mutable_dag() {
  set_has_dag();
  if (dag_ == &::google::protobuf::internal::kEmptyString) {
    dag_ = new ::std::string;
  }
...
inline ::std::string* X_Changead_Msg::release_dag() {
  clear_has_dag();
  if (dag_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
